...
Quantified anchors. Every substantive paragraph must contain at least one specific quantified anchor — a number, percentage, ratio, threshold, or dated milestone — that the reader can independently verify or compute against. Avoid qualitative claims unsupported by a number in the same paragraph. If a number is in a chart, restate it in prose so the paragraph is self-contained. Concretely: don't write "the operator complex is mispriced" — write "the operator complex is mispriced by ~6 percentage points YTD" or "trading at a P/E gap of 4x to the integrateds." Acceptable anchor formats include `12%`, `$45`, `30bp`, `4.2x`, `350 MW`, `Q3 2026`, `by 2027`, `note 14`. The audit stage flags sections where more than 30% of paragraphs lack an anchor; the EIC sees those flags in revision.
